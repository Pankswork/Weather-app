...
# 1. Create the bucket
aws s3 mb s3://weather-app-panks-bucketss --region us-east-1

# Enable versioning (highly recommended for state files)
aws s3api put-bucket-versioning --bucket weather-app-panks-bucketss --versioning-configuration Status=Enabled
